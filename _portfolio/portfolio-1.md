...
excerpt: "Applied statistical analysis and machine learning project to classify rare neutrino interaction events in high-noise IceCube detector data, focusing on model robustness and uncertainty. 1<br/><img src='/images/500x300.png'>"
collection: portfolio
---

I have developed a machine learning pipeline to classify neutrino flavour from high-energy interaction events using data from the IceCube detector, characterized by class imbalance and high observational noise. Here, I conducted extensive exploratory data analysis (EDA) to identify physically motivated features derived from optical sensor hit rates, validating hypotheses through statistical testing, Gaussian modeling, and correlation analysis.
